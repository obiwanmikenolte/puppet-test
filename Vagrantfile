...
Vagrant.configure(2) do |config|
  ...
  config.vm.define "puppet" do |box|
    box.vm.box = "cent/7.1"
    box.vm.hostname = "puppet.example.com"
  ...
  config.vm.define "cent7" do |box|
    box.vm.box = "cent/7.1"
    box.vm.hostname = "cent7.example.com"
    box.vm.network "private_network", ip: "10.1.1.8"
    box.vm.provision "shell" do |s|
      s.path = "box-scripts/base"
    end
  end
  config.vm.define "xenial" do |box|
    box.vm.box = "ubuntu/xenial"
    box.vm.hostname = "xenial.example.com"
